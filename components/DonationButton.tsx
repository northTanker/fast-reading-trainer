...
export default function DonationButton() {
  return (
    <a
      ...
      className="flex items-center gap-2 p-3 sm:px-4 sm:py-2 bg-white/80 dark:bg-zinc-800/80 backdrop-blur-md border border-amber-200/50 dark:border-amber-700/50 rounded-full shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 text-sm font-semibold text-zinc-700 dark:text-zinc-300 group hover:border-amber-400 dark:hover:border-amber-500"
    >
